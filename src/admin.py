...
"""
    ...
    Implements the administrator privilege escalation.
...
class Admin(object):
    ...
    def bootstrap(self, script_path):
        """ Elevated the privilege of the script given
        """
        if script_path == None:
            raise TypeError("No script path provided for escalation")
...
print("[+] Administrator privilege escalation module loaded.")
